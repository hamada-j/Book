            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="index.html"
                      ><img src="${ pageContext.request.contextPath }/resource/images/logo.png" alt="#"
                    /></a>
                  </div>
                </div>
              </div>
      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              class="first-slide"
              src="${ pageContext.request.contextPath }/resource/images/banner.jpg"
              alt="First slide"
            />
            <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-5 col-lg-5 col-md-5 co-sm-l2">
            <div class="about_box">
              <h2>
                About moon<br /><strong class="black"> Farm and company</strong>
              </h2>
              <p>
          ...
          <div class="col-xl-7 col-lg-7 col-md-7 co-sm-l2">
            <div class="about_img">
              <figure><img src="${ pageContext.request.contextPath }/resource/images/about.png" alt="img" /></figure>
            </div>
          </div>
        </div>
      </div>
